...
public class ContactMgrTest {
     ...
     */
    @Test
    public void testRetrieve_Contact() throws Exception {
    ...
    public void testRetrieve_String() throws Exception {
        ...
        List result = instance.retrieve(search);
        assertNotNull(result);
        List result1 = instance.retrieve(search);
        assertNotNull(result1);
        assertNotNull(result1.get(1));
    }
